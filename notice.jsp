...
<form action="notice.jsp" method="get">
 <input name="search" type="text" value="<%=(search==null)?"":search %>" class="input_box">
...
<div id="page_control">
 ...
 if(count>0){
	 //페이지 개수 구하기
	 //전체 글 개수 /한페이지 당 글 개수(+1:나머지 있을때)
	 int pageCount=count/pageSize+(count %pageSize ==0? 0:1);
     
	 //페이지 블록 갯수 설정
	 int pageBlock=5;
	 
	 //시작페이지번호 starPage 구하기
	 ...
	 for(int i = startPage;i<=endPage;i++){
		...
		<% if(i==pageNum){
			...
			<span style ="font-whight:bold; color:red;">[<%=i %>]</span>
